...
void LoadFit(TString Selection=""){
  ...
  vector<TString > FITClasses={"FiledTree","Bins","Weights","RooHSEventsPDF","RooHSEventsHistPDF","Setup","Data","Binner","Minimiser","HSMetropolisHastings","RooMcmc","PlotResults","BootStrapper","FitManager","sPlot","ToyManager","FitSelector","Process"};
