...
void LoadFit(TString Selection=""){
  ...
  vector<TString > FITClasses={"FiledTree","Bins","Weights","PdfParser","RooHSEventsPDF","RooHSEventsHistPDF","RooComponentsPDF","Setup","Data","Binner","Minimiser","HSSequentialProposal","HSMetropolisHastings","RooMcmc","PlotResults","BootStrapper","FitManager","sPlot","ToyManager","FitSelector","Process"};
