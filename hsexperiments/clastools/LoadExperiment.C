...
void LoadExperiment(){
  ...
  if(C12TOOL!=TString("")) {
    ...
    std::vector<TString > C12BClasses={"header","particle","particle_detector","scintillator","calorimeter","cherenkov","forwardtagger","tracker","covmatrix","region_particle","region_ft","region_fdet","region_cdet","hallB_event"};
